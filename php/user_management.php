...
<body class="bg-gray-100 text-gray-800 font-poppins">
    <div class="container mx-auto p-8">
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="../admin.php"
                class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded-lg">Volver al Panel</a>
        </div>

        <!-- Add/Edit User Form -->
        <div class="bg-white p-6 rounded-xl shadow-2xl mb-8">
            <h2 class="text-2xl font-bold mb-6"><?php echo $edit_user ? 'Editar Usuario' : 'Añadir Nuevo Usuario'; ?>
            </h2>
            <form action="user_management.php" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="password" class="block font-semibold mb-2">Contraseña
                            <?php echo $edit_user ? '(dejar en blanco para no cambiar)' : ''; ?></label>
                ...
                <div class="mt-6">
                    <button type="submit"
                        class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-6 rounded-lg">Guardar
                        Usuario</button>
                </div>
            </form>
        </div>
                    ...
                    <tbody class="text-gray-700">
                        <?php while ($row = $users_result->fetch_assoc()): ?>
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="py-3 px-4">
                                    <a href="user_management.php?action=edit&user_id=<?php echo $row['id']; ?>"
                                        class="text-blue-500 hover:text-blue-700 mr-4">Editar</a>
                                    <a href="user_management.php?action=delete&user_id=<?php echo $row['id']; ?>"
